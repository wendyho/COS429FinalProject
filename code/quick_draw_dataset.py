...
#             print('bbox: ', bbox_x, bbox_y, bbox_w, bbox_h)
...
#             final = self.nearest_neighbor(qdg, masked_bbox_image, bbox_x, bbox_y, w, h, logging=False)
#             final = cv2.bitwise_not(final)
    ...
    def plot_histogram(self):
        plt.hist(self.norms, density=False, bins=10)  # `density=False` would make counts
        plt.ylabel('Count')
        plt.xlabel('Frobenius Norm Distance')
        plt.show()   